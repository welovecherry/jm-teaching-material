...
!!! question "확인질문"
    ...
    **A.** **연결/서비스 장애**에 가깝습니다. 다른 사이트는 되는데 특정 사이트만 안 되면, 그 도메인의 DNS(Day3)·경로·방화벽(Day4) 문제일 수 있습니다. 계층 진단(Day1)으로 좁힙니다.
...
!!! question "확인질문"
    ...
    **A.** **시간 순서와 인과(무엇이 먼저 있었고 무엇으로 번졌나)**가 잘 보입니다. "언제 시작돼 어떻게 확산됐는가"를 한눈에 파악해, 초동 대응(5과목 SOAR)과 사후 분석에 유리합니다.
...
!!! question "확인질문"
    ...
    **A.** 네. 산출물(구성도·룰셋·ZT 시나리오·로그 분석)을 근거로 **점수와 개선점을 구체적으로** 제시할 수 있습니다. 오늘 배운 도식화·문서화가 그 설명을 뒷받침합니다.
